$('.brd').css("width", document.body.clientWidth < 1740 ? "90%" : "70%");
$(".postbody, .posthead").css("margin-left", "180px");
$(".post-byline, .post-author").css("margin-left", "-180px").css("padding-left", 0).css("width", "160px");
$(".postfoot").css("padding-left", "180px");
$(".codebox").css("padding-top", "0").css("border", "2px solid #acf").css("border-radius", "5px");
$(".codebox > pre > code").css("font-family", "Droid Sans Mono").css("font-size", "12px !important");

CodeParse('<div style="margin-top:-4px; border-bottom:2px #acf solid; white-space: wrap-word !important; font-size: 12px !important; line-height: 36px;" %bottom%>
    ...
    %copySpace3(<img src="data:image/png;base64,
        ...
        74Yo9mxgFOkj9je06aHJO4pb8AAAAABJRU5ErkJggg==" title="Копировать с 3 пробелами">)% <br></div><br>%code%');
